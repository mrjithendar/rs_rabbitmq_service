...
main ()
{
  repo_config_name=rabbitmq_erlang
  detect_os
  curl_check


  yum_repo_config_url="https://packagecloud.io/install/repositories/rabbitmq/erlang/config_file.repo?os=${os}&dist=${dist}&source=script"
