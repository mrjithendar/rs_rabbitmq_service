...
main ()
{
  repo_config_name=rabbitmq_rabbitmq-server
  detect_os
  curl_check


  yum_repo_config_url="https://packagecloud.io/install/repositories/rabbitmq/rabbitmq-server/config_file.repo?os=${os}&dist=${dist}&source=script"
